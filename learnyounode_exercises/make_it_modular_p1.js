...
// MAKE IT MODULAR - The main program
// Exercise 6 of 13
//
...
//
// You must write a module file to do most of the work. The module must export a
// single function that takes three arguments: the directory name, the filename
// extension string and a callback function, in that order. The filename
// extension argument must be the same as what was passed to your program. Don't
// turn it into a RegExp or prefix with "." or do anything except pass it to your
...
//   data. In this exercise, the data will be your filtered list of files, as an
//   Array. If you receive an error, e.g. from your call to  fs.readdir(), the
//   callback must be called with the error, and only the error, as the first
//   argument.
//
//   You must not print directly to the console from your module file, only from
...
var ls = require('./make_it_modular_p2');

ls(dirname, extname, function (err, data) {
