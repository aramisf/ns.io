...
var server = http.createServer(function(req, res){
  ...
  var req_js = url.parse(req.url, true)
  var d = new Date(req_js.query.iso)  // That was the step I was missing

  res.writeHead(200, { 'Content-Type': 'application/json' })

  if (req_js.pathname == '/api/parsetime')
  ...
  if (req_js.pathname == '/api/unixtime')
